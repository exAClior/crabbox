...
func providerHelpAll() string {
	return "provider: hetzner, aws, azure, gcp, tencent, proxmox, ssh, blacksmith-testbox, namespace-devbox, semaphore, daytona, islo, e2b, or sprites"
}

func providerHelpSSH() string {
	return "provider: hetzner, aws, azure, gcp, tencent, proxmox, ssh, namespace-devbox, semaphore, daytona, or sprites"
}
